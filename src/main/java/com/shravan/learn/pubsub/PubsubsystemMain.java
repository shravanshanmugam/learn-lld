...
// Create topics
        ...
        publisher2.publish(topic2, new Message("Message3 for Topic2"));
        ...
        publisher1.publish(topic1, new Message("Message4 for Topic1"));
        publisher2.publish(topic2, new Message("Message5 for Topic2"));
    }
}
